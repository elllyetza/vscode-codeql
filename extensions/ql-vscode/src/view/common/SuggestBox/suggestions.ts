...
import { CellValue, DecodedBqrsChunk } from "../../../common/bqrs-cli-types";
...
function parseQueryResultsForPath(tuples: CellValue[][]): Option[] {
...
export function parseQueryResults(
  ...
  const tuplesByTypeAndPath = new Map<string, Map<string, CellValue[][]>>();
